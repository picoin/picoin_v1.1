...
{
    QString link="https://picoin.club/";
...
{
    QString link="https://bitcointalk.org/index.php?topic=1771221.0/";
       QDesktopServices::openUrl(QUrl(link));
...
{
    QString link="http://explorer.picoin.club/";
       QDesktopServices::openUrl(QUrl(link));
...
{
    QString link="http://pi.8pool.dtdns.net/";
       QDesktopServices::openUrl(QUrl(link));
...
{
    QString link="http://www.l8nit3-miners.com/";
       QDesktopServices::openUrl(QUrl(link));
